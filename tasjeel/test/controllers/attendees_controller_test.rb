...
class AttendeesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendee" do
    assert_difference('Attendee.count') do
      post attendees_url, params: { attendee: { address: @attendee.address, date_of_birth: @attendee.date_of_birth, identification: @attendee.identification, name: @attendee.name } }
    end
  ...
  test "should update attendee" do
    patch attendee_url(@attendee), params: { attendee: { address: @attendee.address, date_of_birth: @attendee.date_of_birth, identification: @attendee.identification, name: @attendee.name } }
